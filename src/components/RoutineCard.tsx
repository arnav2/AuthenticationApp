...
type TRoutineCardNavigationProp = StackNavigationProp<IRootStackParamList, typeof ScreenNames.EXERCISE>;

interface RoutineCardProps {
  image: any; // Replace 'any' with the appropriate type for your image
  navigation: TRoutineCardNavigationProp;
  exerciseName: string;
